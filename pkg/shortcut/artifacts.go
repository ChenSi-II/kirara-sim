...
var SetNameToKey = map[string]keys.Set{
	...
	"artifact15048":                      keys.Artifact15048,
	"set15048":                           keys.Artifact15048,
	"luhuoronglianzhixin":                keys.Artifact15048,
	...
	"bloodredproof":                      keys.BloodRedProof,
	"bloodred":                           keys.BloodRedProof,
	...
	"glacierandsnowfield":                keys.GlacierAndSnowfield,
	"glacier":                            keys.GlacierAndSnowfield,
	"snowfield":                          keys.GlacierAndSnowfield,
