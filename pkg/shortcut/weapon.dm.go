...
var WeaponNameToKey = map[string]keys.Weapon{
	...
	"ateaspoonoftranscendence":        keys.ATeaspoonOfTranscendence,
	...
	"bladeofatonement":                keys.BladeOfAtonement,
	...
	"forgedbythegoldenmelody":         keys.ForgedByTheGoldenMelody,
	...
	"hereticsmoltenblade":             keys.HereticsMoltenBlade,
	...
	"songofthevigil":                  keys.SongOfTheVigil,
	...
	"xinzhi":                          keys.Xinzhi,
	"newbranch":                       keys.Xinzhi,
	"sprout":                          keys.Xinzhi,
	"yingang":                         keys.Yingang,
	"silverlamp":                      keys.Yingang,
	"silverlantern":                   keys.Yingang,
	"diebian":                         keys.Diebian,
	"metamorphosis":                   keys.Diebian,
	"ningxuechenxin":                  keys.NingxueChenxin,
	"frostboundheart":                 keys.NingxueChenxin,
	"snowboundheart":                  keys.NingxueChenxin,
	"xuanliusongge":                   keys.XuanliuSongge,
	"flowingballad":                   keys.XuanliuSongge,
	"waterballad":                     keys.XuanliuSongge,
