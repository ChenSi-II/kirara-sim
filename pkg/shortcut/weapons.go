...
var WeaponNameToKey = map[string]keys.Weapon{
	"serpenttooth":                    keys.SerpentTooth,
	"sourceofkindling":                keys.SourceOfKindling,
	"lightbearingmoonshard":           keys.LightbearingMoonshard,
	"swanlakeswinterfeather":          keys.SwanlakesWinterFeather,
	"starforgedblade":                 keys.StarforgedBlade,
	"flameforgedinsight":              keys.FlameForgedInsight,
	"escapewheel":                     keys.EscapeWheel,
	"redemptioncleaver":               keys.RedemptionCleaver,
	"keyoftranscendence":              keys.KeyOfTranscendence,
	"faescrystalle":                   keys.FaesCrystalle,
	"watchsong":                       keys.Watchsong,
	"disasterandremorse":              keys.DisasterAndRemorse,
	"sandmemoria":                     keys.SandMemoria,
	"heartsecho":                      keys.HeartsEcho,
	"shatteredmirror":                 keys.ShatteredMirror,
	"frostboundoath":                  keys.FrostboundOath,
