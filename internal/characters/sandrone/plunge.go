...
func (c *char) plunge(p map[string]int, high bool) (action.Info, error) {
	...
	if p["collision"] != 0 {
		ai := info.AttackInfo{ActorIndex: c.Index(), Abil: "Plunge Collision", AttackTag: attacks.AttackTagPlunge, ICDTag: attacks.ICDTagNone, ICDGroup: attacks.ICDGroupDefault, StrikeType: attacks.StrikeTypeBlunt, Element: attributes.Physical, Mult: collision[c.TalentLvlAttack()]}
	...
	ai := info.AttackInfo{ActorIndex: c.Index(), Abil: abil, AttackTag: attacks.AttackTagPlunge, ICDTag: attacks.ICDTagNone, ICDGroup: attacks.ICDGroupDefault, StrikeType: attacks.StrikeTypeBlunt, Element: attributes.Physical, Mult: mult}
